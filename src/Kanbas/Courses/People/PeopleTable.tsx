        ...
        <tbody>
          <tr>
            <td className="wd-full-name text-nowrap">
              ...
              <span className="wd-first-name">Ghanashyam</span>{" "}
              <span className="wd-last-name">Vagale</span>
            </td>
            <td className="wd-login-id">001234560S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">TA</td>
            <td className="wd-last-activity">2020-11-06</td>
            <td className="wd-total-activity">14:29:03</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">15:43:12</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">18:21:39</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">08:12:51</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">21:01:45</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-12-07</td>
            <td className="wd-total-activity">12:11:57</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">07:36:13</td>
          </tr>
          ...
          <tr>
            ...
            <td className="wd-total-activity">05:12:06</td>
          </tr>
        </tbody>
      </table>
    </div>
